...
INSERT INTO positions (position_id, position_name) VALUES
	...
	(2, 'CENTER_BACK'),  
	(3, 'LEFT_RIGHT_BACK'),   
	(4, 'LEFT_RIGHT_WING_BACK'),   
	(5, 'CENTRAL_DEFENSIVE_MIDFIELDER'),   
	(6, 'CENTRAL_MIDFIELDER'),   
	(7, 'CENTRAL_ATTACKING_MIDFIELDER'),   
	(8, 'LEFT_RIGHT_WING'),  
	(9, 'STRIKER_CENTER_FORWARD'),   
	(10, 'SECOND_STRIKER');  
   

INSERT INTO team (team_id, team_name, team_region,  team_rating_average, recruitment_status, created_person, created_date, modified_person, modified_date, team_introduction, team_attachment_enabled, is_deleted) VALUES
    (1, 'Team1', 'CAPITAL_REGION', 1.76, TRUE, 'User1', '2025-05-17 20:52:28', 'User1', '2025-05-17 20:52:28', 'This is team 1''s introduction.', TRUE, FALSE),
    (2, 'Team2', 'YEONGNAM_REGION', 1.52, FALSE, 'User2', '2025-05-17 20:52:28', 'User2', '2025-05-17 20:52:28', 'This is team 2''s introduction.', TRUE, FALSE),
    (3, 'Team3', 'HONAM_REGION', 3.09, TRUE, 'User3', '2025-05-17 20:52:28', 'User3', '2025-05-17 20:52:28', 'This is team 3''s introduction.', TRUE, FALSE),
    (4, 'Team4', 'CHUNGCHEONG_REGION', 2.67, FALSE, 'User4', '2025-05-17 20:52:28', 'User4', '2025-05-17 20:52:28', 'This is team 4''s introduction.', TRUE, FALSE),
    (5, 'Team5', 'GANGWON_REGION',  2.08, TRUE, 'User5', '2025-05-17 20:52:28', 'User5', '2025-05-17 20:52:28', 'This is team 5''s introduction.', TRUE, FALSE),
    (6, 'Team6', 'JEJU', 2.76, FALSE, 'User6', '2025-05-17 20:52:28', 'User6', '2025-05-17 20:52:28', 'This is team 6''s introduction.', TRUE, FALSE),
    (7, 'Team7', 'CAPITAL_REGION', 2.20, TRUE, 'User7', '2025-05-17 20:52:28', 'User7', '2025-05-17 20:52:28', 'This is team 7''s introduction.', TRUE, FALSE),
    (8, 'Team8', 'YEONGNAM_REGION', 1.48, FALSE, 'User8', '2025-05-17 20:52:28', 'User8', '2025-05-17 20:52:28', 'This is team 8''s introduction.', TRUE, FALSE),
    (9, 'Team9', 'HONAM_REGION', 4.86, TRUE, 'User9', '2025-05-17 20:52:28', 'User9', '2025-05-17 20:52:28', 'This is team 9''s introduction.', TRUE, FALSE),
    (10, 'Team10', 'CHUNGCHEONG_REGION', 4.11, FALSE, 'User10', '2025-05-17 20:52:28', 'User10', '2025-05-17 20:52:28', 'This is team 10''s introduction.', TRUE, FALSE);

INSERT INTO member (member_id, member_email, member_password, member_name, member_role, position_id, preferred_time, team_id, my_temperature, picture_attachment_enabled, created_date, modified_date, is_deleted) VALUES
    (1, 'user1@example.com', 'password1', 'Member1', 'USER', 1, 'WEEKEND_MORNING', 1, 35.8, TRUE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE),
    (2, 'user2@example.com', 'password2', 'Member2', 'USER', 2, 'WEEKEND_AFTERNOON', 2, 36.9, FALSE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE),
    (3, 'user3@example.com', 'password3', 'Member3', 'USER', 3, 'WEEKEND_EVENING', 3, 39.9, TRUE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE),
    (4, 'user4@example.com', 'password4', 'Member4', 'USER', 4, 'WEEKDAY_MORNING', 4, 39.0, FALSE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE),
    (5, 'user5@example.com', 'password5', 'Member5', 'USER', 5, 'WEEKDAY_AFTERNOON', 5, 39.1, TRUE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE),
    (6, 'user6@example.com', 'password6', 'Member6', 'USER', 6, 'WEEKDAY_EVENING', 6, 36.5, FALSE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE),
    (7, 'user7@example.com', 'password7', 'Member7', 'USER', 7, 'WEEKEND_MORNING', 7, 38.8, TRUE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE),
    (8, 'user8@example.com', 'password8', 'Member8', 'USER', 8, 'WEEKEND_AFTERNOON', 8, 36.1, FALSE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE),
    (9, 'user9@example.com', 'password9', 'Member9', 'USER', 9, 'WEEKEND_EVENING', 9, 35.9, TRUE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE),
    (10, 'user10@example.com', 'password10', 'Member10', 'USER', 10, 'WEEKDAY_MORNING', 10, 36.9, FALSE, '2025-05-17 20:52:28', '2025-05-17 20:52:28', FALSE);
...
INSERT INTO host_profile (host_profile_id, host_id, host_name, created_date, modified_date, picture_attachment_enabled) VALUES
    (1, 1, 'Host1', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE),
    (2, 2, 'Host2', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE),
    (3, 3, 'Host3', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE),
    (4, 4, 'Host4', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE),
    (5, 5, 'Host5', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE),
    (6, 6, 'Host6', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE),
    (7, 7, 'Host7', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE),
    (8, 8, 'Host8', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE),
    (9, 9, 'Host9', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE),
    (10, 10, 'Host10', '2025-05-17 20:52:28', '2025-05-17 20:52:28', TRUE);
...
INSERT INTO matchup_board (matchup_board_id, writer_id, sports_type_id, reservation_attachment_enabled, team_intro, sports_facility_name, sports_facility_address, match_datetime, match_duration, current_participant_count, max_participants, min_manner_temperature, match_description, created_date, created_person, modified_date, modified_person, is_deleted) VALUES
    ...
    (5, 5, 1, TRUE, 'Team introduction by Member5''s team.', 'Sports Center 5', 'Address 5', '2025-05-22 20:52:28', '01:00:00', 5, 10, 35.9, 'Description for matchup board 5', '2025-05-17 20:52:28', 'Member5', '2025-05-17 20:52:28', 'Member5', FALSE),
    (6, 6, 1, TRUE, 'Team introduction by Member6''s team.', 'Sports Center 6', 'Address 6', '2025-05-23 20:52:28', '02:00:00', 4, 10, 37.9, 'Description for matchup board 6', '2025-05-17 20:52:28', 'Member6', '2025-05-17 20:52:28', 'Member6', FALSE),
    (7, 7, 2, TRUE, 'Team introduction by Member7''s team.', 'Sports Center 7', 'Address 7', '2025-05-24 20:52:28', '01:00:00', 1, 10, 37.9, 'Description for matchup board 7', '2025-05-17 20:52:28', 'Member7', '2025-05-17 20:52:28', 'Member7', FALSE),
    (8, 8, 2, TRUE, 'Team introduction by Member8''s team.', 'Sports Center 8', 'Address 8', '2025-05-25 20:52:28', '02:00:00', 5, 10, 37.2, 'Description for matchup board 8', '2025-05-17 20:52:28', 'Member8', '2025-05-17 20:52:28', 'Member8', FALSE),
    (9, 9, 1, TRUE, 'Team introduction by Member9''s team.', 'Sports Center 9', 'Address 9', '2025-05-26 20:52:28', '01:00:00', 6, 10, 37.7, 'Description for matchup board 9', '2025-05-17 20:52:28', 'Member9', '2025-05-17 20:52:28', 'Member9', FALSE),
    (10, 10, 1, TRUE, 'Team introduction by Member10''s team.', 'Sports Center 10', 'Address 10', '2025-05-27 20:52:28', '02:00:00', 1, 10, 37.8, 'Description for matchup board 10', '2025-05-17 20:52:28', 'Member10', '2025-05-17 20:52:28', 'Member10', FALSE);
...
INSERT INTO event_request (event_id, host_id, event_date, event_region, event_title, host_profile_id,  event_method, event_contact, event_status, created_date, created_person, modified_date, modified_person, is_deleted) VALUES
    (1, 1, '2025-05-17', 'CAPITAL_REGION', 'Event 1 Title', 1, 'Online', '010-0000-0001', 'APPROVED', '2025-05-17 20:52:28', 'Member1', '2025-05-17 20:52:28', 'Member1', FALSE),
    (2, 2, '2025-05-17', 'YEONGNAM_REGION', 'Event 2 Title', 1, 'Offline', '010-0000-0002', 'DENIED', '2025-05-17 20:52:28', 'Member2', '2025-05-17 20:52:28', 'Member2', FALSE),
    (3, 3, '2025-05-17', 'HONAM_REGION', 'Event 3 Title', 2, 'Online', '010-0000-0003', 'PENDING', '2025-05-17 20:52:28', 'Member3', '2025-05-17 20:52:28', 'Member3', FALSE),
    (4, 4, '2025-05-17', 'CHUNGCHEONG_REGION', 'Event 4 Title', 2, 'Offline', '010-0000-0004', 'APPROVED', '2025-05-17 20:52:28', 'Member4', '2025-05-17 20:52:28', 'Member4', FALSE),
    (5, 5, '2025-05-17', 'GANGWON_REGION', 'Event 5 Title', 3, 'Online', '010-0000-0005', 'DENIED', '2025-05-17 20:52:28', 'Member5', '2025-05-17 20:52:28', 'Member5', FALSE),
    (6, 6, '2025-05-17', 'JEJU', 'Event 6 Title', 3, 'Offline', '010-0000-0006', 'PENDING', '2025-05-17 20:52:28', 'Member6', '2025-05-17 20:52:28', 'Member6', FALSE),
    (7, 7, '2025-05-17', 'CAPITAL_REGION', 'Event 7 Title', 3, 'Online', '010-0000-0007', 'APPROVED', '2025-05-17 20:52:28', 'Member7', '2025-05-17 20:52:28', 'Member7', FALSE),
    (8, 8, '2025-05-17', 'YEONGNAM_REGION', 'Event 8 Title', 4, 'Offline', '010-0000-0008', 'DENIED', '2025-05-17 20:52:28', 'Member8', '2025-05-17 20:52:28', 'Member8', FALSE),
    (9, 9, '2025-05-17', 'HONAM_REGION', 'Event 9 Title', 4, 'Online', '010-0000-0009', 'PENDING', '2025-05-17 20:52:28', 'Member9', '2025-05-17 20:52:28', 'Member9', FALSE),
    (10, 10, '2025-05-17', 'CHUNGCHEONG_REGION', 'Event 10 Title', 4, 'Offline', '010-0000-0010', 'APPROVED', '2025-05-17 20:52:28', 'Member10', '2025-05-17 20:52:28', 'Member10', FALSE);
...
INSERT INTO guest_board (guest_board_id, writer_id, sports_type_id, preferred_position_id, picture_attachment_enabled, self_intro, preferred_region1, preferred_region2, preferred_region3, preferred_time1, preferred_time2, preferred_time3, preferred_time4, preferred_time5, preferred_time6, created_date, created_person, modified_date, modified_person, is_deleted) VALUES
    ...
    (5, 5, 1, 5, TRUE, 'Self introduction of Member5 as guest.', 'Daejeon', 'Gwangju', NULL, 'WEEKDAY_AFTERNOON', 'WEEKDAY_EVENING', NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member5', '2025-05-17 20:52:28', 'Member5', FALSE),
    (6, 6, 1, 6, TRUE, 'Self introduction of Member6 as guest.', 'Gwangju', NULL, NULL, 'WEEKDAY_EVENING', NULL, NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member6', '2025-05-17 20:52:28', 'Member6', FALSE),
    (7, 7, 2, 7, TRUE, 'Self introduction of Member7 as guest.', 'Suwon', NULL, NULL, 'WEEKEND_MORNING', NULL, NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member7', '2025-05-17 20:52:28', 'Member7', FALSE),
    (8, 8, 2, 8, TRUE, 'Self introduction of Member8 as guest.', 'Ulsan', NULL, NULL, 'WEEKEND_AFTERNOON', NULL, NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member8', '2025-05-17 20:52:28', 'Member8', FALSE),
    (9, 9, 1, 9, TRUE, 'Self introduction of Member9 as guest.', 'Jeju', NULL, NULL, 'WEEKEND_EVENING', NULL, NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member9', '2025-05-17 20:52:28', 'Member9', FALSE),
    (10, 10, 1, 10, TRUE, 'Self introduction of Member10 as guest.', 'Sejong', NULL, NULL, 'WEEKDAY_MORNING', NULL, NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member10', '2025-05-17 20:52:28', 'Member10', FALSE);
