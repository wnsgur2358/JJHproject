...
VALUES ('MATCHON 소개', 'MATCHON은 실시간 매칭 시스템을 기반으로 한 유저 친화적 스포츠 매칭 플랫폼입니다!'),
       ...
       ('매너온도', '매치온의 핵심 기능인 매너온도는 유저가 받은 피드백을 바탕으로 실력과 스포츠맨십을 보여주는 지표입니다. 경기를 생성할 때 매너온도 기준을 설정하여 경기 분위기를 조성할 수 있으며, 다양한 실력대의 사용자들과 더욱 뜨겁고 열정적이고 즐거운 경기를 경험할 수 있습니다.');