...
(
    ...
    created_person  VARCHAR(100)        NULL,
    modified_date   DATETIME                    DEFAULT current_timestamp on update current_timestamp,
    modified_person VARCHAR(100)        NULL,
...
(
    ...
    is_deleted              BOOLEAN  DEFAULT FALSE,
    CONSTRAINT FK_team_2_chat_room FOREIGN KEY (chat_room_id) REFERENCES chat_room (chat_room_id)    
...
(
    ...
    applicant_id        BIGINT,
    team_id             BIGINT,
    join_request_status ENUM('PENDING', 'APPROVED', 'DENIED') NOT NULL,
    introduction        TEXT,
    created_person      VARCHAR(100),
    created_date        DATETIME DEFAULT current_timestamp,
    modified_person     VARCHAR(100),
...
CREATE TABLE host_profile (
                              ...
                              CONSTRAINT UK_host_name UNIQUE (host_name)
...
(
    ...
    CONSTRAINT UK_team_id_2_position_id UNIQUE (team_id, position_id)
);
...
(
    ...
    modified_date   DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    modified_person VARCHAR(100),
    CONSTRAINT FK_chat_participant_2_member_blocker FOREIGN KEY (blocker_id) REFERENCES member (member_id),
    CONSTRAINT FK_chat_participant_2_member_blocked FOREIGN KEY (blocked_id) REFERENCES member (member_id),
