...
-- CREATE DATABASE IF NOT EXISTS matchon_test;
USE matchon_test;
...
CREATE TABLE team(
	...
	is_deleted BOOLEAN DEFAULT FALSE,
	CONSTRAINT FK_team_2_sports_type FOREIGN KEY (sports_type) REFERENCES sports_type(sports_type_id), -- team:spors_type = N:1
...
CREATE TABLE member (
    ...
    CONSTRAINT FK_member_2_sports_type FOREIGN KEY (sports_type_id) REFERENCES sports_type(sports_type_id), -- MEMBER:sports_type = N:1
...
CREATE TABLE inquiry (
    ...
    inquiry_category ENUM('tg(team, guest)', 'event', 'tutorial', 'manner_temperature', 'community', 'account', 'report') NOT NULL,
...
CREATE TABLE faq (
    faq_id BIGINT AUTO_INCREMENT PRIMARY KEY,
   	...
   	faq_category ENUM('tg(team, guest)', 'event', 'tutorial', 'manner_temperature', 'community', 'account', 'report') NOT NULL,
