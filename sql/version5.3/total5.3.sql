...
(
    ...
    team_id          BIGINT,
    CONSTRAINT fk_chatroom_team FOREIGN KEY (team_id) REFERENCES team(team_id) ON DELETE SET NULL
...
(
    ...
    is_rating_initialized 		    BOOLEAN           NOT NULL DEFAULT FALSE,
    created_date                   DATETIME                    DEFAULT CURRENT_TIMESTAMP,
    created_person                 VARCHAR(100)        NOT NULL,
    modified_date                  DATETIME                    DEFAULT current_timestamp on update current_timestamp,
    modified_person                VARCHAR(100)        NOT NULL,
...
(
    ...
    chat_room_id        BIGINT             NOT NULL,
    member_id           BIGINT             NOT NULL,
    chat_role			ENUM('OWNER', 'ADMIN', 'MEMBER') DEFAULT 'MEMBER',
    created_date        DATETIME                    DEFAULT CURRENT_TIMESTAMP,
    created_person      VARCHAR(100)        NOT NULL,
    modified_date       DATETIME                    DEFAULT current_timestamp on update current_timestamp,
    modified_person     VARCHAR(100)        NOT NULL,
