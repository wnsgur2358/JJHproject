...
VALUES
    ...
    ('GUEST_BOARD', 2, 1, 'file2.png', 'file2_saved.png', '/uploads/2025/05/', '/uploads/2025/05/thumb/file2_saved.png', '2025-05-17 20:52:28', 'System', '2025-05-17 20:52:28', 'System', FALSE),
    ('GUEST_REQUEST', 3, 1, 'file3.pdf', 'file3_saved.pdf', '/uploads/2025/05/', NULL, '2025-05-17 20:52:28', 'System', '2025-05-17 20:52:28', 'System', FALSE),
...
INSERT INTO guest_board (writer_id, sports_type_id, preferred_position_id, picture_attachment_enabled,
                         self_intro, preferred_region1, preferred_region2, preferred_region3, preferred_time1,
                         preferred_time2, preferred_time3, preferred_time4, preferred_time5, preferred_time6,
                         created_date, created_person, modified_date, modified_person, is_deleted)
VALUES (1, 1, 1, TRUE, 'Self introduction of Member1 as guest.', 'Seoul', 'Busan', 'Incheon', 'WEEKEND_MORNING',
        'WEEKEND_AFTERNOON', NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member1', '2025-05-17 20:52:28', 'Member1',
        FALSE),
       (2, 1, 2, TRUE, 'Self introduction of Member2 as guest.', 'Busan', 'Incheon', 'Daegu', 'WEEKEND_AFTERNOON',
        'WEEKEND_EVENING', NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member2', '2025-05-17 20:52:28', 'Member2',
        FALSE),
       (3, 2, 3, TRUE, 'Self introduction of Member3 as guest.', 'Incheon', 'Daegu', NULL, 'WEEKEND_EVENING',
        'WEEKDAY_MORNING', NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member3', '2025-05-17 20:52:28', 'Member3',
        FALSE),
       (4, 2, 4, TRUE, 'Self introduction of Member4 as guest.', 'Daegu', 'Daejeon', NULL, 'WEEKDAY_MORNING',
        'WEEKDAY_AFTERNOON', NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member4', '2025-05-17 20:52:28', 'Member4',
        FALSE),
       (5, 1, 5, TRUE, 'Self introduction of Member5 as guest.', 'Daejeon', 'Gwangju', NULL, 'WEEKDAY_AFTERNOON',
        'WEEKDAY_EVENING', NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member5', '2025-05-17 20:52:28', 'Member5',
        FALSE),
       (6, 1, 6, TRUE, 'Self introduction of Member6 as guest.', 'Gwangju', NULL, NULL, 'WEEKDAY_EVENING', NULL,
        NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member6', '2025-05-17 20:52:28', 'Member6', FALSE),
       (7, 2, 7, TRUE, 'Self introduction of Member7 as guest.', 'Suwon', NULL, NULL, 'WEEKEND_MORNING', NULL, NULL,
        NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member7', '2025-05-17 20:52:28', 'Member7', FALSE),
       (8, 2, 8, TRUE, 'Self introduction of Member8 as guest.', 'Ulsan', NULL, NULL, 'WEEKEND_AFTERNOON', NULL,
        NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member8', '2025-05-17 20:52:28', 'Member8', FALSE),
       (9, 1, 9, TRUE, 'Self introduction of Member9 as guest.', 'Jeju', NULL, NULL, 'WEEKEND_EVENING', NULL, NULL,
        NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member9', '2025-05-17 20:52:28', 'Member9', FALSE),
       (10, 1, 10, TRUE, 'Self introduction of Member10 as guest.', 'Sejong', NULL, NULL, 'WEEKDAY_MORNING', NULL,
        NULL, NULL, NULL, NULL, '2025-05-17 20:52:28', 'Member10', '2025-05-17 20:52:28', 'Member10', FALSE);

INSERT INTO guest_request (guest_board_id, applicant_id, reservation_attachment_enabled, self_intro,
                           sports_facility_name, sports_facility_address, match_date, match_duration, match_description,
                           status, request_submitted_count, cancel_submitted_count, created_date, created_person, modified_date, modified_person, is_deleted)
VALUES (1, 2, TRUE, 'Self introduction by Member2 for guest request 1', 'Sports Center G1', 'Address G1',
        '2025-05-18 20:52:28', '01:00:00', 'Description for guest request 1', 'APPROVED', 1, 0, '2025-05-17 20:52:28',
        'Member2', '2025-05-17 20:52:28', 'Member2', FALSE),
       (2, 3, TRUE, 'Self introduction by Member3 for guest request 2', 'Sports Center G2', 'Address G2',
        '2025-05-19 20:52:28', '02:00:00', 'Description for guest request 2', 'DENIED', 1, 0,  '2025-05-17 20:52:28',
        'Member3', '2025-05-17 20:52:28', 'Member3', FALSE),
       (3, 4, TRUE, 'Self introduction by Member4 for guest request 3', 'Sports Center G3', 'Address G3',
        '2025-05-20 20:52:28', '01:00:00', 'Description for guest request 3', 'PENDING', 1, 0,  '2025-05-17 20:52:28',
        'Member4', '2025-05-17 20:52:28', 'Member4', FALSE),
       (4, 5, TRUE, 'Self introduction by Member5 for guest request 4', 'Sports Center G4', 'Address G4',
        '2025-05-21 20:52:28', '02:00:00', 'Description for guest request 4', 'APPROVED', 1, 0,  '2025-05-17 20:52:28',
        'Member5', '2025-05-17 20:52:28', 'Member5', FALSE),
       (5, 6, TRUE, 'Self introduction by Member6 for guest request 5', 'Sports Center G5', 'Address G5',
        '2025-05-22 20:52:28', '01:00:00', 'Description for guest request 5', 'DENIED', 1, 0,  '2025-05-17 20:52:28',
        'Member6', '2025-05-17 20:52:28', 'Member6', FALSE),
       (6, 7, TRUE, 'Self introduction by Member7 for guest request 6', 'Sports Center G6', 'Address G6',
        '2025-05-23 20:52:28', '02:00:00', 'Description for guest request 6', 'PENDING', 1, 0,  '2025-05-17 20:52:28',
        'Member7', '2025-05-17 20:52:28', 'Member7', FALSE),
       (7, 8, TRUE, 'Self introduction by Member8 for guest request 7', 'Sports Center G7', 'Address G7',
        '2025-05-24 20:52:28', '01:00:00', 'Description for guest request 7', 'APPROVED', 1, 0,  '2025-05-17 20:52:28',
        'Member8', '2025-05-17 20:52:28', 'Member8', FALSE),
       (8, 9, TRUE, 'Self introduction by Member9 for guest request 8', 'Sports Center G8', 'Address G8',
        '2025-05-25 20:52:28', '02:00:00', 'Description for guest request 8', 'DENIED', 1, 0,  '2025-05-17 20:52:28',
        'Member9', '2025-05-17 20:52:28', 'Member9', FALSE),
       (9, 10, TRUE, 'Self introduction by Member10 for guest request 9', 'Sports Center G9', 'Address G9',
        '2025-05-26 20:52:28', '01:00:00', 'Description for guest request 9', 'PENDING', 1, 0,  '2025-05-17 20:52:28',
        'Member10', '2025-05-17 20:52:28', 'Member10', FALSE),
       (10, 1, TRUE, 'Self introduction by Member1 for guest request 10', 'Sports Center G10', 'Address G10',
        '2025-05-27 20:52:28', '02:00:00', 'Description for guest request 10', 'APPROVED', 1, 0,  '2025-05-17 20:52:28',
        'Member1', '2025-05-17 20:52:28', 'Member1', FALSE);

INSERT INTO guest_rating (request_id, evaluator_id, target_member_id, manner_score, skill_score,
                          review, created_date, created_person, modified_date, modified_person)
VALUES (1, 2, 1, 3, 5, 'Review for guest request 1', '2025-05-17 20:52:28', 'Member2', '2025-05-17 20:52:28',
        'Member2'),
       (2, 3, 2, 5, 4, 'Review for guest request 2', '2025-05-17 20:52:28', 'Member3', '2025-05-17 20:52:28',
        'Member3'),
       (3, 4, 3, 1, 5, 'Review for guest request 3', '2025-05-17 20:52:28', 'Member4', '2025-05-17 20:52:28',
        'Member4'),
       (4, 5, 4, 5, 1, 'Review for guest request 4', '2025-05-17 20:52:28', 'Member5', '2025-05-17 20:52:28',
        'Member5'),
       (5, 6, 5, 2, 3, 'Review for guest request 5', '2025-05-17 20:52:28', 'Member6', '2025-05-17 20:52:28',
        'Member6'),
       (6, 7, 6, 5, 3, 'Review for guest request 6', '2025-05-17 20:52:28', 'Member7', '2025-05-17 20:52:28',
        'Member7'),
       (7, 8, 7, 1, 4, 'Review for guest request 7', '2025-05-17 20:52:28', 'Member8', '2025-05-17 20:52:28',
        'Member8'),
       (8, 9, 8, 1, 1, 'Review for guest request 8', '2025-05-17 20:52:28', 'Member9', '2025-05-17 20:52:28',
        'Member9'),
       (9, 10, 9, 5, 3, 'Review for guest request 9', '2025-05-17 20:52:28', 'Member10', '2025-05-17 20:52:28',
        'Member10'),
       (10, 1, 10, 4, 5, 'Review for guest request 10', '2025-05-17 20:52:28', 'Member1', '2025-05-17 20:52:28',
        'Member1');
